...
public class WxRefundUtilsH5 {
	
	final static String KEYSTORE_FILE = Payment.WX.H5_KEYSTORE_FILE;//证书路径
	final static String KEYSTORE_PASSWORD = Payment.WX.H5_MCH_ID;//证书密码默认为商户ID
	final static String URL = "https://api.mch.weixin.qq.com/secapi/pay/refund";
	private static String partnerkey = Payment.WX.H5_KEY;//微信支付的API密钥
	...
	public static boolean doRefund(String out_trade_no,String out_refund_no,double total_fee,double refund_fee) throws Exception{
		...
		map.put("appid",  Payment.WX.H5_APP_ID);
		map.put("mch_id",  Payment.WX.H5_MCH_ID);
		...
		map.put("op_user_id",  Payment.WX.H5_MCH_ID);
